...
if [[ $(md5sum $SCRATCH/1.copy | awk '{print $1}') -eq '0af623d6d8cb0a514816e17c7386a298' ]] &&
   [[ $(md5sum $SCRATCH/2.copy | awk '{print $1}') -eq '307fe5cee7ac87c3b06ea5bda80301ee' ]] &&
   [[ $(md5sum $SCRATCH/9.copy | awk '{print $1}') -eq 'fa4280d88da260281e509296fd2f3ea2' ]]; then
    echo "Success"
else
    echo "Failure"
fi
